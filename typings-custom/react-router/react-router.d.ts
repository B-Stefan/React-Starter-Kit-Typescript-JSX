...
declare module "react-router" {
    import React = __React;
    export function match(options:any, callback:(error:any,redirectLocation:any,renderProps:any)=>any);

    export class RoutingContext extends React.Component<any,any> {
        public render();
    }
